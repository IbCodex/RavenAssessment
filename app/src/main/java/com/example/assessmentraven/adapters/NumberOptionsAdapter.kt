...
class NumberOptionsAdapter(context: Context): ArrayAdapter<String>(context, android.R.layout.simple_spinner_item) {

    init {
        val genderOptions = context.resources.getStringArray(R.array.number_options)
